...
export class MyStenCil extends React.Component{
  ...
  private graphRef = React.createRef<MyGraphContaioner>();
  ...
  componentDidMount=()=>{
    ...
    const ICC =makeCircleOptions({componentName:'ICC',system:[],type:'ecu',id:'ICC'})
    // const ICCNode= as any
    //@ts-ignore
    ...
    this.stencil.load([r],'userAction')
    // stencil.load([r.clone(),r.clone(),r,r,r],'userAction')
    //  setTimeout(() => {
    //  }, 1000);
  }
  ...
  render(): React.ReactNode {
    ...
    <Style>
      <Button onClick={()=>{this.stencil.load([new Rect({
      width: 70,
      height: 40,
      attrs: {
        rect: { fill: '#31D0C6', stroke: '#4B4A67', strokeWidth: 6 },
