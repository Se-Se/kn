...
export const Page: React.FC = () => {
  ...
  // 获取详情信息
  const fetch = () => {
    getSoftwareDetail({softwareId:Number(params.certificateId)}).then((res:any)=>{
      if(res.code === 0){
                    ...
                    <Row>
                      ...
                      <Col span={6}>
                        <Row>
                          ...
                          <Col span={2}>
                            <span>{detailData.certificatePurpose}</span>
                          </Col>
                        </Row>
                      </Col>
                    </Row>
                    ...
                    <Row>
                      <Col span={6}>
                        <Row>
                          ...
                          <Col span={2}>
                            <span>{detailData.certificatePath}</span>
                          </Col>
                        </Row>
                      </Col>
                      <Col span={6}>
              ...
              <TableContent>
                <Tabs placement={"top"} size={"medium"} defaultValue={"1"}>
                  <TabPanel value="1" label="详细信息">
                    <MyUpload  softWareId={Number(params.certificateId)}></MyUpload>

                  </TabPanel>
                  <TabPanel value="2" label="系统信息">
                    <SystemDataTable softWareId={Number(params.certificateId)}></SystemDataTable>
